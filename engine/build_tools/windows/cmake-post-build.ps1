...
if (!(Test-Path "SDL2.dll")) {
    Copy-Item -Path "..\..\..\third_party\sdl-windows\lib\x64\SDL2.dll"
}

if (!(Test-Path "SDL2_image.dll")) {
    Copy-Item -Path "..\..\..\third_party\sdl-image-windows\lib\x64\SDL2_image.dll"
}

if (!(Test-Path "libpng16-16.dll")) {
    Copy-Item -Path "..\..\..\third_party\sdl-image-windows\lib\x64\libpng16-16.dll"
}

if (!(Test-Path "zlib1.dll")) {
    Copy-Item -Path "..\..\..\third_party\sdl-image-windows\lib\x64\zlib1.dll"
}

# if (!(Test-Path "nfd.lib")) {
#     Copy-Item -Path "..\..\..\third_party\nfd\lib\x64\nfd.dll"
# }
